...
CMS_URL=http://127.0.0.1:3010 NEXT_PUBLIC_CMS_URL=https://cms.marketeconomy.org NEXT_PUBLIC_MEDIA_URL=https://storage.googleapis.com/marketeconomy-media pnpm --filter @marketeconomy/web build
